...
if (chaincon == 2.3)
{
    ...
    if (spikemake == 1)
    {
        box.image_xscale += 0.0025;
        box.image_yscale += 0.0025;
        spike.image_xscale += 0.0025;
        spike.image_yscale += 0.0025;
...
if (bulletpoint == 1)
{
    with (obj_regularbullet)
    {
        if (sprite_index == spr_spadebullet)
        {
            ...
            {
                image_xscale += 0.00025;
                image_yscale += 0.00025;
            }
            else
            {
                active = 0;
