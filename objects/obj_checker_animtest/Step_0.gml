if (type == 0)
{
    ...
    if (con == 18 && !d_ex())
    {
        ...
        depth = 4000;
        scr_move_to_point_over_time(global.monstermakex[0], global.monstermakey[0], 40);
        con = 19;
        alarm[4] = 40;
    }
...
if (type == 2)
{
    ...
    if (con == 70 && !d_ex())
    {
        snd_volume(global.currentsong[1], 0, 100);
