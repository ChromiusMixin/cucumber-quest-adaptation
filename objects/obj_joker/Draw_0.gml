if (state == 3)
{
    if (hurttimer > 0)
    {
        ...
        {
            if (mhpratio > 0)
                obj_jokerbg_triangle_real.rotspeed = 0.5 + (0.75 - (mhpratio * 1.5));
        }
...
if (state == 0)
{
    ...
    if (flash == 1)
    {
        ...
        with (body)
        {
            ...
            if (dancelv == 1)
                draw_sprite_ext(spr_joker_dance, floatsiner / 6, offx + flyx, offy + fly, 2, 2, 0, image_blend, (-cos(fsiner / 5) * 0.4) + 0.6);
