...
if (joker == 1)
{
    ...
    if (type == 70)
    {
        if (btimer >= 40 && global.turntimer >= 60)
        {
    ...
    if (type == 71)
    {
        if (btimer >= 18 && global.turntimer >= 40)
        {
            jokerx = choose(obj_battlesolid.x - 100 - random(100), obj_battlesolid.x + 100 + random(100));
            jokery = choose(obj_battlesolid.y - random(100), obj_battlesolid.y + random(100));
            jokern = instance_create(jokerx, jokery, obj_joker_teleport);
    ...
    if (type == 77)
    {
        ...
        if (special == 2)
        {
            ...
            if (jokertimer == 80 || jokertimer == 196)
            {
            ...
            if (jokertimer == 92 || jokertimer == 172)
            {
            ...
            if (jokertimer == 104 || jokertimer == 160)
            {
            ...
            if (jokertimer == 132 || jokertimer == 196)
