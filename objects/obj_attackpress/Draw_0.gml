...
if (active == 1)
{
    for (i = 0; i < 3; i += 1)
    {
        ...
        if (global.char[i] != 0 && global.charauto[global.char[i]] == 0 && havechar[i] == 1)
        {
            ...
            draw_rectangle(x + 78, y + (38 * i), x + 80 + (30 * boltspeed), y + (38 * i) + 36, true);
            draw_rectangle(x + 79, y + (38 * i) + 1, (x + 80 + (30 * boltspeed)) - 1, y + (38 * i) + 35, true);
    ...
    else
    {
        ...
        if (posttimer < (timermax - 70))
            posttimer = timermax - 68;
    }
    ...
    if (goahead == 1)
    {
        ...
        if (posttimer > (timermax - 70) && haveauto == 1 && autoed == 0 && scr_monsterpop() > 0)
        {
