...
if (con == 5)
{
    ...
    speed = point_distance(x, y, global.monstermakex[0], global.monstermakey[0]) / 20;
    copyhave = 0;
    ...
    for (cc = 0; cc < 2; cc += 1)
    {
        if (global.monstertype[cc + 1] != 0)
        {
            ...
            if (global.monstertype[cc + 1] == global.monstertype[0])
            {
                ...
                copy[cc].speed = point_distance(x, y, global.monstermakex[cc + 1], global.monstermakey[cc + 1]) / 20;
            ...
            else
            {
                ...
                with (copy[cc])
                {
                    ...
                    speed = point_distance(x, y, global.monstermakex[cc + 1], global.monstermakey[cc + 1]) / 20;
                }
            }
        }
    }
