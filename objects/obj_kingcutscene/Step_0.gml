if (con < 76)
{
    ...
    if (con == 48 && !d_ex())
    {
        ...
        for (i = 0; i < 3; i += 1)
        {
            ...
            spadechunk[i].hspeed = 1;
            spadechunk[i].friction = 0.025;
        }
    ...
    if (con == 74)
    {
        if (!instance_exists(obj_battlecontroller))
        {
            ...
            with (king)
                scr_move_to_point_over_time(remkingx, remkingy, 20);
...
if (con >= 76 && con < 150)
{
    ...
    if (con == 106 && !d_ex())
    {
        ...
        {
            image_speed = 0.125;
            move_towards_point(king.x - 90, king.y + 50, 1);
        }
    ...
    if (con == 133 && !d_ex())
    {
        ...
        spadechunk2.hspeed = 1;
        spadechunk2.friction = 0.025;
        i = 0;
    ...
    if (con == 136 && !d_ex())
    {
        ...
        spadechunk2.hspeed = (hdisto / 2) + 3.5;
        spadechunk2.friction = -0.25;
        ...
        {
            scr_anim(465, 0.25);
            move_towards_point(s.x + 60, s.y + 10, disto / 2);
        }
...
if (con >= 150 && con < 250)
{
    ...
    if (con == 159 && !d_ex())
    {
        ...
        if (king.image_index >= 4)
        {
            ...
            spadechunk4.vspeed = -1;
            spadechunk4.friction = 0.025;
    ...
    if (con == 190 && !d_ex())
    {
        ...
        for (i = 0; i < 2; i += 1)
        {
            ...
            spadechunkf[i].vspeed = -2;
            spadechunkf[i].friction = 0.125;
        }
    }
    ...
    if (con == 191)
    {
        for (i = 0; i < 2; i += 1)
        {
            spadechunkf[i].image_alpha += 0.05;
...
if (con >= 700)
{
    if (con == 700 && global.plot >= 243 && global.interact == 0 && obj_mainchara.x >= 1900)
    {
        ...
        mus_volume(global.currentsong[1], 0, 160);
        instance_create(0, 0, obj_dialoguer);
    }
