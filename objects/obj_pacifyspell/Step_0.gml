...
if (con == 1)
{
    ...
    {
        siner += 0.5;
        target.image_blend = merge_color(target.image_blend, flashcolor, 0.05);
...
if (con == 6)
    target.image_blend = merge_color(target.image_blend, flashcolor, 0.06);
...
if (con == 8)
    target.image_blend = merge_color(target.image_blend, c_white, 0.08);
