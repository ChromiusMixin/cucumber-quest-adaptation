...
if (BGMADE == 1)
{
    ...
    T_SINER_ADD = (sin(ANIM_SINER_B / 2.5) * 0.6) - 0.0625;
    
    if (T_SINER_ADD >= 0)
        TRUE_ANIM_SINER += T_SINER_ADD;
    
    draw_sprite_ext(IMAGE_MENU_ANIMATION, ANIM_SINER / 24, 0, ((10 - (BG_ALPHA * 20)) + __WAVEHEIGHT) - 70, 1, 1, 0, image_blend, BG_ALPHA * 0.26);
    draw_sprite_ext(IMAGE_MENU_ANIMATION, (ANIM_SINER / 24) + 0.2, 0, ((10 - (BG_ALPHA * 20)) + __WAVEHEIGHT) - 70, 1, 1, 0, image_blend, BG_ALPHA * 0.31);
    draw_sprite_ext(IMAGE_MENU_ANIMATION, (ANIM_SINER / 24) + 0.4, 0, ((10 - (BG_ALPHA * 20)) + __WAVEHEIGHT) - 70, 1, 1, 0, image_blend, BG_ALPHA * 0.36);
    draw_sprite_ext(IMAGE_MENU_ANIMATION, (ANIM_SINER / 24) + 0.6, 0, ((10 - (BG_ALPHA * 20)) + __WAVEHEIGHT) - 70, 1, 1, 0, image_blend, BG_ALPHA * 0.44);
    draw_sprite_ext(IMAGE_MENU_ANIMATION, (ANIM_SINER / 24) + 0.8, 0, ((10 - (BG_ALPHA * 20)) + __WAVEHEIGHT) - 70, 1, 1, 0, image_blend, BG_ALPHA * 0.5);
}
...
if (MENU_NO >= 0)
{
    ...
    if (MENU_NO == 0 || MENU_NO == 1)
    {
        ...
        QUITTEXT = (TYPE == 1) ? "End Program" : "END PROGRAM";
        ...
        draw_text_shadow(204, 190, QUITTEXT);
...
HEARTXCUR += ((HEARTX - HEARTXCUR) / 4);
HEARTYCUR += ((HEARTY - HEARTYCUR) / 4);
