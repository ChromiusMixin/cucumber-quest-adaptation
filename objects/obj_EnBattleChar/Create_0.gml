...
ID = instance_number(obj_EnBattleChar)-1
Name = global.Troop[ID].NameShort
LV = 5
MHP = 228+(LV*12);
MMP = 347+(LV*3);
HP = MHP;
...
MenuOffsetX = 20;
MenuOffsetY = -30;
Skills = global.Troop[ID].Skills
BaseAtk = global.Troop[ID].BaseAtk
SkQueue = BaseAtk.obj
MagicOptions = variable_struct_names_count(Skills)
SynOptions = 3;
holdanim = 0
Icon = global.Troop[ID].Icon
Delay = 2
Flash = 0
SkillID = 0
PlayerID = 0
...
Dmg = 0
DmgRdc = 0
DmgColor = global.Troop[ID].DmgColor


//Generic Animations
Anims = global.Troop[ID].Anims
Snds = global.Troop[ID].Snds
