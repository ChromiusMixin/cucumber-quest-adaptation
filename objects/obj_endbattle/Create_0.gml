...
if (global.specialbattle == 0 || global.specialbattle == 3)
{
    ...
    for (i = 0; i < (count + 1); i += 1)
    {
        if (i == 0)
        {
            ...
            c[i].speed = point_distance(c[i].x, c[i].y, obj_mainchara.x, obj_mainchara.y) / 20;
            c[i].depth = 200 - (i * 20);
        }
        ...
        if (i == 1 || i == 2)
        {
            ...
            c[i].speed = point_distance(c[i].x, c[i].y, global.cinstance[i - 1].x, global.cinstance[i - 1].y) / 20;
            c[i].depth = 200 - (i * 20);
        }
    }
