...
if (global.myfight == 3)
{
    ...
    if (actcon == 10)
    {
        ...
        with (k)
            scr_move_to_point_over_time(global.monsterx[0] - 42, global.monstery[0] - 30, 30);
    ...
    if (actcon == 18)
    {
        ...
        with (k)
            scr_move_to_point_over_time(global.charinstance[0].x, global.charinstance[0].y, 30);
    ...
    if (actcon == 30)
    {
        ...
        with (k)
            scr_move_to_point_over_time(obj_heroralsei.x - 24, obj_heroralsei.y + 10, 30);
