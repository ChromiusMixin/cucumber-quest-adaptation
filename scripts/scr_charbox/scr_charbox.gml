        ...
        if (havechar[c] == 1)
        {
            ...
            if (global.fighting == 1)
            {
                ...
                if (spare_glow == 1 && gc == charpos[c])
                    draw_sprite_ext(scr_84_get_sprite("spr_btspare"), 2, xx + xchunk + 120, (485 - bp) + yy, 1, 1, 0, c_white, 0.4 + (sin(global.time / 12) * 0.4));
                
                if (pacify_glow == 1 && gc == charpos[c])
                    draw_sprite_ext(scr_84_get_sprite("spr_bttech"), 2, xx + xchunk + 50, (485 - bp) + yy, 1, 1, 0, c_white, 0.4 + (sin(global.time / 12) * 0.4));
            }
